...
# Class Parser - Classe responsável por parsear cada uma das informações e ler o arquivo modelo de payload
...
class Parser
    ...
    # metodos que quando solicitados buscam a informacao correta no arquivo completo
    # se precisar alterar alguma regra não afeta no processamento inteiro
